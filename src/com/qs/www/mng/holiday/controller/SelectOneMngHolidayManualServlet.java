...
@WebServlet("/mng/holiday/manual/selectOne")
public class SelectOneMngHolidayManualServlet extends HttpServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int memberNo = Integer.parseInt(request.getParameter("no"));    //선택한 사원의 사번
		MngHolidayService mngHolidayService = new MngHolidayService();
		MemberHolidayInfoDTO memberHolidayInfo = mngHolidayService.selectMemberHolidayInfo(memberNo);
		...
		int totalCount = mngHolidayService.selectHolidayLogCount(countMap);
		...
		request.getRequestDispatcher("/WEB-INF/views/mngholiday/detailHolidayManual.jsp").forward(request, response);
	}
