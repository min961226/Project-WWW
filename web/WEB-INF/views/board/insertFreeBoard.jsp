			...
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
							...
							<form class="form-horizontal" action="${ pageContext.servletContext.contextPath }/board/free/insert" method="post" onsubmit="return askAgain();"  enctype="multipart/form-data">
