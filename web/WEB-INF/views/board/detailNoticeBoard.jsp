					...
					<div class="row">
						<div class="form-group">
							<div class="col-xs-12">
								<label>제목</label>
								<div class="col-md-12">
									<input name = "title" class="form-control" value="${ requestScope.notice.title }"  disabled/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							<div class="col-sm-12">
								<label>작성자</label>
								<div class="col-md-12">
									<input name = "name" class="form-control" value="${ requestScope.notice.name }"  disabled/>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								...
								<textarea name="body" rows="8" cols="5" class="form-control"
										required="required" disabled>${ requestScope.notice.body }</textarea>
								</div>
							</div>
						</div>
					</div>
