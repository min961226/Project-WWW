							...
							<form class="form-horizontal" action="${ pageContext.servletContext.contextPath }/approval/applied/selectOne?no=${ requestScope.selectedReport.reportNo }" method="post">
								...
								<div id="area3" class="form-group" >
									...
									<div class="col-sm-6">
										<label>시작시간</label>
										<div class="col-md-12">
											<input class="form-control" value="${ requestScope.startDateTime }"  disabled/>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<label>종료시간</label>
										<div class="col-md-12">
											<input class="form-control" value="${ requestScope.endDateTime }"  disabled/>
										</div>
									</div>
									...
									<div class="col-sm-6">
										...
										<div class="col-md-12">
											<input class="form-control" value="${ requestScope.overtimeDuring }"  disabled/>
										</div>
									</div>
