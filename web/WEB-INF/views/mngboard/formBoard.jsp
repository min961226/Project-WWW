    ...
    <div class="main-wrapper">
		...
		<div class="page-wrapper">
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <h4 class="page-title">문서서식 게시판</h4>
                    </div>
                </div>
                
                <!-- 검색 시작 -->
                <div class="search-area" align="right">
             		<form id="loginForm" action="${ pageContext.servletContext.contextPath }/mng/board/form/select" method="get" style="display:inline-block">		
	                    ...
	                    <div class="card-box">
	                    	<div class="card-block">
	                            <table class="display datatable table table-stripped">
	                                ...
	                                <c:forEach var="board" items="${ requestScope.mngformList }">
										<tr>
   	...
   	<script>
		if(document.getElementsByTagName("td")) {
			...
			for(let i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					location.href = "${ pageContext.servletContext.contextPath }/mng/board/form/selectOne?no=" + no;
				}
		...
		if(document.getElementsByTagName("writeFree")) {
    		...
    		$goBack.onclick = function() {
    			location.href = "${ pageContext.servletContext.contextPath }/mng/board/form/insert"
    		}
		}
