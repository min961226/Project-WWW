				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal"
							action="${ pageContext.servletContext.contextPath }/mng/board/notice/update"
								...
								<div class="col-sm-12">
									...
									<div class="col-md-12">
										<input type="text" name="title" class="form-control"
											required="required" value="${ requestScope.mngnotice.title }">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-12">
									...
									<div class="col-md-12" align="center">
										...
										<textarea name="body" rows="8" cols="5" class="form-control"
											required="required">${ requestScope.mngnotice.body }</textarea>
