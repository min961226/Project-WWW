                	...
                	<div class="col-lg-6 col-md-6 col-xs-12">
	                    <div class="card-box">
	                       	...
	                       	<div class="panel-body">
	                       		...
	                       		<div><h5><c:out value="오늘까지 정규근무시간 : ${ requestScope.workTimeSum }시간 [잔여 : ${ 40 - requestScope.workTimeSum } 시간]"/></h5></div>
                                <div class="progress">
                                ...
                                <div><h5><c:out value="오늘까지 초과근무시간 : ${ requestScope.overtimeSum } 시간 [잔여 : ${ 12 - requestScope.overtimeSum } 시간]"/></h5></div>
                                <div class="progress">
