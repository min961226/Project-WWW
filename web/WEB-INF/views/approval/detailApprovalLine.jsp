					...
					<div class="col-lg-12">
						<div class="form-group">
							<div class="col-sm-6">
								...
								<div class="col-md-12">
									<input class="form-control"
										value="${ requestScope.line.lineName }" disabled />
								</div>
							</div>
							...
							<div class="col-sm-6">
								...
								<div class="col-md-12">
									<input class="form-control"
										value="${ requestScope.line.workType }" disabled />
								</div>
							</div>
						</div>
						<br> <br> <br>
						...
						<c:forEach var="approver" items="${ requestScope.approverList}">
							<div class="card-box col-lg-12">
								...
								<label>결재방법</label> <input name="approverType"
									value=${ approver.approverType } disabled />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>결재자부서</label>
								<input name="approverName" value=${ approver.deptName } disabled />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>결재자직위</label>
								<input name="approverName" value=${ approver.jobName } disabled />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>결재자명</label> <input
									name="approverName" value=${ approver.approverName } disabled />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
