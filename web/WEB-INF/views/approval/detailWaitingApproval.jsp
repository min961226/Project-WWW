						...
						<form class="form-horizontal"
							...
							<div class="card-box col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<label>결재처리</label> <input type="radio" name="radio"
											value='승인' checked id="APPY"><label for="APPY">승인</label>
										<input type="radio" name="radio" value='반려' id="APPN"><label
											for="APPN">반려</label>
									...
									<div class="col-md-12">
										...
										<div class="col-sm-6">
											<textarea name="opinion" rows="4" cols="6"
												class="form-control" placeholder="의견을 입력해주세요"
