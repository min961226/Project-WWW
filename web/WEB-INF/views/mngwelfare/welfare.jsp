					...
					<div class="card-block">
						<div class="row">
							<form name="insertSelfDev"
								action="${ pageContext.servletContext.contextPath }/mng/welfare/list/update"
								method="POST">
								<div class="col-sm-12">
									<h6 class="panel-title m-b-20">
										<b>시행 복지 목록</b>
									</h6>
									<div class="panel">
											<ul class="list-group">
										...
										<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
												...
												<input name="nightTransNo" value="${ welfareYn.documentNo }" hidden="hidden"> 
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="nightTransYn" id="nightTransYn" type="checkbox" value="N">
																<label for="nightTransYn" class="label-success"></label>
															</div>
														</c:if>
													</c:if>
												...
												<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="eventYn" id="eventYn" type="checkbox" value="N"> 
																<label for="eventYn" class="label-success"></label>
															</div>
														</c:if>
													</c:if>
												...
												<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="selfDevYn" id="selfDevYn" type="checkbox" value="N">
																<label	for="selfDevYn" class="label-success"></label>
															</div>
														</c:if>
													</c:if>
												...
												<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="domitoryYn" id="domitoryYn" type="checkbox" value="N">
																<label for="domitoryYn" class="label-success"></label>
															</div>
														</c:if>
													</c:if>
												...
												<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="seminarYn" id="seminarYn" type="checkbox" value="N"> 
																<label for="seminarYn" class="label-success"></label>
															</div>
														</c:if>
													</c:if>
												...
												<c:forEach var="welfareYn" items="${ requestScope.welfareYn }">
													 ...
													 <input name="laptopNo" value="${ welfareYn.documentNo }" hidden="hidden"> 
														...
														<c:if test="${ welfareYn.useYn eq 'N' }">
															<div class="material-switch pull-right" align="left">
																<input name="laptopYn" id="laptopYn" type="checkbox" value="N"> 
																<label for="laptopYn"	class="label-success"></label>
															</div>
														</c:if>
													</c:if>
