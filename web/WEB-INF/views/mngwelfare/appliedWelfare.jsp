...
<body>
 ...
 <!-- 검색 시작 -->
                <div class="search-area" align="right">
                   <form id="loginForm" action="${ pageContext.servletContext.contextPath }/mng/welfare/applied/select" method="get" style="display:inline-block">      
                   <input type="hidden" name="currentPage" value="1">
                  <select id="searchCondition" name="searchCondition">
                      <option value="title" ${ requestScope.selectCriteria.searchCondition eq "title"? "selected": "" }>제목</option>
                     <option value="name" ${ requestScope.selectCriteria.searchCondition eq "name"? "selected": "" }>신청자</option>
								...
								<div class="table-responsive">
									<table class="table table-striped custom-table m-b-0 datatable">
										...
										<c:forEach var="welfareList"
											items="${ requestScope.allAppliedWelfareList }">
                                	...
                                	-->
											...
											<tr>
												...
												<td><c:out value="${ welfareList.memberName }" /></td>
		...
		if (document.getElementsByTagName("td")) {
			...
			for (let i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					location.href = "${ pageContext.servletContext.contextPath }/mng/welfare/list/selectOne?no="+ no;
