                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table m-b-0 datatable">
                                ...
                                <c:forEach var="welfareList" items="${ requestScope.appliedWelfareList }">
										...
										<td> 
											<c:choose>
												<c:when test="${ isApproved }">
													<i class="fa fa-dot-circle-o text-success"></i><c:out value=" ${ welfareList.reportStatus }"/>
												</c:when>
												<c:otherwise>
													<i class="fa fa-dot-circle-o text-danger"></i><c:out value=" ${ welfareList.reportStatus }"/>
												</c:otherwise>
											</c:choose>
										</td>
